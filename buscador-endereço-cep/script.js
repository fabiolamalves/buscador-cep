const INPUT_CEP = document.getElementById('cep'); // chamar a const ganha performance e torna menos verboso
...
INPUT_CEP.addEventListener('blur', () => {
    //é interessante fazer uma análise para saber se tem 8 caracteres
